...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.leonardomota.cursomc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API Sistema de Pedidos",
				"Esta API é utilizada no curso de Spring Boot do prof. Nelio Alves", 
				"Versão 1.0",
				"https://www.udemy.com/terms",
				new Contact("Leonardo Silveira", "udemy.com/user/leonardo-da-silva-mota-silveira/", "leonardomota14@gmail.com"),
