...
import com.leonardomota.cursomc.services.exceptions.AuthorizationException;
import com.leonardomota.cursomc.services.exceptions.DataIntegratyException;
...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegratyException("Não é possível excluir porque há pedidos relacionados!");
		}
	}
	...
	public Cliente findByEmail(String email) {
		...
		if(obj==null) {
			throw new ObjectNotFoundException(
					"Objeto não encontrago! Id: " + user.getId() + ", Tipo: " + Cliente.class.getName());
